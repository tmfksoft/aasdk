...
extern PROTOBUF_INTERNAL_EXPORT_VideoConfigData_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_VideoConfig_VideoConfigData_2eproto;
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
class AVChannelDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<AVChannel> _instance;
} _AVChannel_default_instance_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static void InitDefaultsscc_info_AVChannel_AVChannelData_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_AVChannel_AVChannelData_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_AVChannel_AVChannelData_2eproto}, {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::data::AVChannel)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_AVChannelData_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AVChannelData_2eproto = {
  false, false, descriptor_table_protodef_AVChannelData_2eproto, "AVChannelData.proto", 427,
  &descriptor_table_AVChannelData_2eproto_once, descriptor_table_AVChannelData_2eproto_sccs, descriptor_table_AVChannelData_2eproto_deps, 1, 4,
  schemas, file_default_instances, TableStruct_AVChannelData_2eproto::offsets,
  file_level_metadata_AVChannelData_2eproto, 1, file_level_enum_descriptors_AVChannelData_2eproto, file_level_service_descriptors_AVChannelData_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_AVChannelData_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_AVChannelData_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
void AVChannel::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AVChannel_AVChannelData_2eproto.base);
...
// @@protoc_insertion_point(class_specific_merge_from_start:f1x.aasdk.proto.data.AVChannel)
  ...
  if (from.audio_type() != 0) {
    _internal_set_audio_type(from._internal_audio_type());
  }
