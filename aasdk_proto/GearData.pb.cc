...
static void InitDefaultsscc_info_Gear_GearData_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Gear_GearData_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Gear_GearData_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_GearData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::Gear, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::Gear, gear_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::data::Gear)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::f1x::aasdk::proto::data::_Gear_default_instance_),
};
...
const char descriptor_table_protodef_GearData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "GearEnum.proto\"6\n\004Gear\022.\n\004gear\030\001 \001(\0162 .f"
  "1x.aasdk.proto.enums.Gear.Enumb\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_GearData_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GearData_2eproto = {
  false, false, descriptor_table_protodef_GearData_2eproto, "GearData.proto", 118,
  &descriptor_table_GearData_2eproto_once, descriptor_table_GearData_2eproto_sccs, descriptor_table_GearData_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_GearData_2eproto::offsets,
  file_level_metadata_GearData_2eproto, 1, file_level_enum_descriptors_GearData_2eproto, file_level_service_descriptors_GearData_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_GearData_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_GearData_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
Gear::Gear(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:f1x.aasdk.proto.data.Gear)
}
...
const Gear& Gear::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Gear_GearData_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_gear(static_cast<::f1x::aasdk::proto::enums::Gear_Enum>(val));
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::data::Gear* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::data::Gear >(Arena* arena) {
  return Arena::CreateMessageInternal< ::f1x::aasdk::proto::data::Gear >(arena);
}
