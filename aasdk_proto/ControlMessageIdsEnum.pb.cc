...
static void InitDefaultsscc_info_ControlMessage_ControlMessageIdsEnum_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ControlMessage_ControlMessageIdsEnum_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ControlMessage_ControlMessageIdsEnum_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::ids::ControlMessage)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::f1x::aasdk::proto::ids::_ControlMessage_default_instance_),
};
...
const char descriptor_table_protodef_ControlMessageIdsEnum_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ControlMessageIdsEnum_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ControlMessageIdsEnum_2eproto_sccs[1] = {
  &scc_info_ControlMessage_ControlMessageIdsEnum_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ControlMessageIdsEnum_2eproto = {
  false, false, descriptor_table_protodef_ControlMessageIdsEnum_2eproto, "ControlMessageIdsEnum.proto", 514,
  &descriptor_table_ControlMessageIdsEnum_2eproto_once, descriptor_table_ControlMessageIdsEnum_2eproto_sccs, descriptor_table_ControlMessageIdsEnum_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_ControlMessageIdsEnum_2eproto::offsets,
  file_level_metadata_ControlMessageIdsEnum_2eproto, 1, file_level_enum_descriptors_ControlMessageIdsEnum_2eproto, file_level_service_descriptors_ControlMessageIdsEnum_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ControlMessageIdsEnum_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ControlMessageIdsEnum_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace ids {
...
const ControlMessage& ControlMessage::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ControlMessage_ControlMessageIdsEnum_2eproto.base);
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::ids::ControlMessage* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::ids::ControlMessage >(Arena* arena) {
