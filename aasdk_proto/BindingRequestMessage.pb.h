...
class BindingRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.messages.BindingRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.messages.BindingRequest";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_BindingRequestMessage_2eproto);
    return ::descriptor_table_BindingRequestMessage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  mutable std::atomic<int> _scan_codes_cached_byte_size_;
