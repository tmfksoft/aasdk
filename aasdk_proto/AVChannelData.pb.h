...
class AVChannel PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.data.AVChannel) */ {
 public:
  ...
  inline AVChannel* New() const final {
    return CreateMaybeMessage<AVChannel>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.data.AVChannel";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_AVChannelData_2eproto);
    return ::descriptor_table_AVChannelData_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::AudioConfig >*
      mutable_audio_configs();
  private:
  const ::f1x::aasdk::proto::data::AudioConfig& _internal_audio_configs(int index) const;
  ::f1x::aasdk::proto::data::AudioConfig* _internal_add_audio_configs();
  public:
  const ::f1x::aasdk::proto::data::AudioConfig& audio_configs(int index) const;
  ::f1x::aasdk::proto::data::AudioConfig* add_audio_configs();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::AudioConfig >&
      audio_configs() const;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::VideoConfig >*
      mutable_video_configs();
  private:
  const ::f1x::aasdk::proto::data::VideoConfig& _internal_video_configs(int index) const;
  ::f1x::aasdk::proto::data::VideoConfig* _internal_add_video_configs();
  public:
  const ::f1x::aasdk::proto::data::VideoConfig& video_configs(int index) const;
  ::f1x::aasdk::proto::data::VideoConfig* add_video_configs();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::VideoConfig >&
      video_configs() const;
  ...
  private:
  ::f1x::aasdk::proto::enums::AudioType_Enum _internal_audio_type() const;
  void _internal_set_audio_type(::f1x::aasdk::proto::enums::AudioType_Enum value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::AudioConfig > audio_configs_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::VideoConfig > video_configs_;
  int stream_type_;
  int audio_type_;
...
inline ::f1x::aasdk::proto::enums::AVStreamType_Enum AVChannel::_internal_stream_type() const {
...
inline void AVChannel::_internal_set_stream_type(::f1x::aasdk::proto::enums::AVStreamType_Enum value) {
...
inline ::f1x::aasdk::proto::enums::AudioType_Enum AVChannel::_internal_audio_type() const {
...
inline void AVChannel::_internal_set_audio_type(::f1x::aasdk::proto::enums::AudioType_Enum value) {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::AudioConfig >*
...
inline const ::f1x::aasdk::proto::data::AudioConfig& AVChannel::_internal_audio_configs(int index) const {
...
inline ::f1x::aasdk::proto::data::AudioConfig* AVChannel::_internal_add_audio_configs() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::AudioConfig >&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::VideoConfig >*
...
inline const ::f1x::aasdk::proto::data::VideoConfig& AVChannel::_internal_video_configs(int index) const {
...
inline ::f1x::aasdk::proto::data::VideoConfig* AVChannel::_internal_add_video_configs() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1x::aasdk::proto::data::VideoConfig >&
