...
class VideoFocusIndication PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.messages.VideoFocusIndication) */ {
 public:
  ...
  inline VideoFocusIndication* New() const final {
    return CreateMaybeMessage<VideoFocusIndication>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.messages.VideoFocusIndication";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_VideoFocusIndicationMessage_2eproto);
    return ::descriptor_table_VideoFocusIndicationMessage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::f1x::aasdk::proto::enums::VideoFocusMode_Enum VideoFocusIndication::_internal_focus_mode() const {
...
inline void VideoFocusIndication::_internal_set_focus_mode(::f1x::aasdk::proto::enums::VideoFocusMode_Enum value) {
