...
static void InitDefaultsscc_info_BindingResponse_BindingResponseMessage_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BindingResponse_BindingResponseMessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_BindingResponse_BindingResponseMessage_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_BindingResponseMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_BindingResponseMessage_2eproto_sccs[1] = {
  &scc_info_BindingResponse_BindingResponseMessage_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_BindingResponseMessage_2eproto = {
  false, false, descriptor_table_protodef_BindingResponseMessage_2eproto, "BindingResponseMessage.proto", 145,
  &descriptor_table_BindingResponseMessage_2eproto_once, descriptor_table_BindingResponseMessage_2eproto_sccs, descriptor_table_BindingResponseMessage_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_BindingResponseMessage_2eproto::offsets,
  file_level_metadata_BindingResponseMessage_2eproto, 1, file_level_enum_descriptors_BindingResponseMessage_2eproto, file_level_service_descriptors_BindingResponseMessage_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_BindingResponseMessage_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_BindingResponseMessage_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace messages {
...
const BindingResponse& BindingResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_BindingResponse_BindingResponseMessage_2eproto.base);
