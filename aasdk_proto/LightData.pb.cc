...
static void InitDefaultsscc_info_Light_LightData_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::f1x::aasdk::proto::data::_Light_default_instance_;
    new (ptr) ::f1x::aasdk::proto::data::Light();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::f1x::aasdk::proto::data::Light::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Light_LightData_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Light_LightData_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::data::Light)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_LightData_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_LightData_2eproto = {
  false, false, descriptor_table_protodef_LightData_2eproto, "LightData.proto", 264,
  &descriptor_table_LightData_2eproto_once, descriptor_table_LightData_2eproto_sccs, descriptor_table_LightData_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_LightData_2eproto::offsets,
  file_level_metadata_LightData_2eproto, 1, file_level_enum_descriptors_LightData_2eproto, file_level_service_descriptors_LightData_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_LightData_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_LightData_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
const Light& Light::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Light_LightData_2eproto.base);
...
// @@protoc_insertion_point(generalized_merge_from_start:f1x.aasdk.proto.data.Light)
  GOOGLE_DCHECK_NE(&from, this);
  const Light* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Light>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:f1x.aasdk.proto.data.Light)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:f1x.aasdk.proto.data.Light)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:f1x.aasdk.proto.data.Light)
  ...
  if (from.indicator() != 0) {
    _internal_set_indicator(from._internal_indicator());
  }
  if (from.hazard_light_on() != 0) {
    _internal_set_hazard_light_on(from._internal_hazard_light_on());
  }
}

void Light::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:f1x.aasdk.proto.data.Light)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
