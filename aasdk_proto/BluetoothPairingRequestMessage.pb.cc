...
const char descriptor_table_protodef_BluetoothPairingRequestMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n$BluetoothPairingRequestMessage.proto\022\030"
  "f1x.aasdk.proto.messages\032 BluetoothPairi"
  "ngMethodEnum.proto\"|\n\027BluetoothPairingRe"
  "quest\022\025\n\rphone_address\030\001 \001(\t\022J\n\016pairing_"
...
::PROTOBUF_NAMESPACE_ID::uint8* BluetoothPairingRequest::_InternalSerialize(
  ...
  if (this->phone_address().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "f1x.aasdk.proto.messages.BluetoothPairingRequest.phone_address");
...
// @@protoc_insertion_point(class_specific_copy_from_start:f1x.aasdk.proto.messages.BluetoothPairingRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
