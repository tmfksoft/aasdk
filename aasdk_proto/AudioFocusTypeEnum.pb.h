...
enum AudioFocusType_Enum : int {
  ...
  AudioFocusType_Enum_AudioFocusType_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  AudioFocusType_Enum_AudioFocusType_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class AudioFocusType PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.AudioFocusType) */ {
 public:
  ...
  inline AudioFocusType* New() const final {
    return CreateMaybeMessage<AudioFocusType>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.enums.AudioFocusType";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_AudioFocusTypeEnum_2eproto.file_level_metadata[kIndexInFileMessages];
  }
