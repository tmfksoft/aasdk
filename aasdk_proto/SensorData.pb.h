...
class Sensor PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.data.Sensor) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.data.Sensor";
  }
  protected:
  ...
  private:
  ::f1x::aasdk::proto::enums::SensorType_Enum _internal_type() const;
  void _internal_set_type(::f1x::aasdk::proto::enums::SensorType_Enum value);
  public:
...
inline ::f1x::aasdk::proto::enums::SensorType_Enum Sensor::_internal_type() const {
...
inline void Sensor::_internal_set_type(::f1x::aasdk::proto::enums::SensorType_Enum value) {
