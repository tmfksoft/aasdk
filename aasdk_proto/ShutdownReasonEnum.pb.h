...
enum ShutdownReason_Enum : int {
  ...
  ShutdownReason_Enum_ShutdownReason_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ShutdownReason_Enum_ShutdownReason_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class ShutdownReason PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.ShutdownReason) */ {
 public:
  ...
  inline ShutdownReason* New() const final {
    return CreateMaybeMessage<ShutdownReason>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_ShutdownReasonEnum_2eproto.file_level_metadata[kIndexInFileMessages];
  }
