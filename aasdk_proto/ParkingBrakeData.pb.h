...
class ParkingBrake PROTOBUF_FINAL :
 ...
 public:
  ...
  inline ParkingBrake* New() const final {
    return CreateMaybeMessage<ParkingBrake>(nullptr);
  }

  ParkingBrake* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ParkingBrakeData_2eproto);
    return ::descriptor_table_ParkingBrakeData_2eproto.file_level_metadata[kIndexInFileMessages];
  }
