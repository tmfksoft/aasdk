...
static void InitDefaultsscc_info_RelativeInputEvent_RelativeInputEventData_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::f1x::aasdk::proto::data::_RelativeInputEvent_default_instance_;
    new (ptr) ::f1x::aasdk::proto::data::RelativeInputEvent();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::f1x::aasdk::proto::data::RelativeInputEvent::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RelativeInputEvent_RelativeInputEventData_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RelativeInputEvent_RelativeInputEventData_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_RelativeInputEventData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::RelativeInputEvent, scan_code_),
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::RelativeInputEvent, delta_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::data::RelativeInputEvent)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::f1x::aasdk::proto::data::_RelativeInputEvent_default_instance_),
};
...
const char descriptor_table_protodef_RelativeInputEventData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_RelativeInputEventData_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_RelativeInputEventData_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RelativeInputEventData_2eproto = {
  false, false, descriptor_table_protodef_RelativeInputEventData_2eproto, "RelativeInputEventData.proto", 116,
  &descriptor_table_RelativeInputEventData_2eproto_once, descriptor_table_RelativeInputEventData_2eproto_sccs, descriptor_table_RelativeInputEventData_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_RelativeInputEventData_2eproto::offsets,
  file_level_metadata_RelativeInputEventData_2eproto, 1, file_level_enum_descriptors_RelativeInputEventData_2eproto, file_level_service_descriptors_RelativeInputEventData_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_RelativeInputEventData_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_RelativeInputEventData_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
const RelativeInputEvent& RelativeInputEvent::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_RelativeInputEvent_RelativeInputEventData_2eproto.base);
...
// @@protoc_insertion_point(generalized_merge_from_start:f1x.aasdk.proto.data.RelativeInputEvent)
  GOOGLE_DCHECK_NE(&from, this);
  const RelativeInputEvent* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RelativeInputEvent>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:f1x.aasdk.proto.data.RelativeInputEvent)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:f1x.aasdk.proto.data.RelativeInputEvent)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:f1x.aasdk.proto.data.RelativeInputEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::data::RelativeInputEvent* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::data::RelativeInputEvent >(Arena* arena) {
