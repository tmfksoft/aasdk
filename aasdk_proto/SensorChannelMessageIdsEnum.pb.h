...
enum SensorChannelMessage_Enum : int {
  ...
  SensorChannelMessage_Enum_SensorChannelMessage_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SensorChannelMessage_Enum_SensorChannelMessage_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class SensorChannelMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.ids.SensorChannelMessage) */ {
 public:
  ...
  inline SensorChannelMessage* New() const final {
    return CreateMaybeMessage<SensorChannelMessage>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.ids.SensorChannelMessage";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_SensorChannelMessageIdsEnum_2eproto.file_level_metadata[kIndexInFileMessages];
  }
