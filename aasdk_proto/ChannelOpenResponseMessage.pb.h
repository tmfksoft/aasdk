...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ChannelOpenResponseMessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ChannelOpenResponseMessage_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ChannelOpenResponseMessage_2eproto;
namespace f1x {
namespace aasdk {
namespace proto {
namespace messages {
...
class ChannelOpenResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.messages.ChannelOpenResponse) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1x.aasdk.proto.messages.ChannelOpenResponse";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ChannelOpenResponseMessage_2eproto);
    return ::descriptor_table_ChannelOpenResponseMessage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::f1x::aasdk::proto::enums::Status_Enum ChannelOpenResponse::_internal_status() const {
...
inline void ChannelOpenResponse::_internal_set_status(::f1x::aasdk::proto::enums::Status_Enum value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ChannelOpenResponseMessage_2eproto
