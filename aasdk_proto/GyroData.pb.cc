...
class GyroDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Gyro> _instance;
} _Gyro_default_instance_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static void InitDefaultsscc_info_Gyro_GyroData_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Gyro_GyroData_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Gyro_GyroData_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::f1x::aasdk::proto::data::Gyro)},
};
...
const char descriptor_table_protodef_GyroData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\004Gyro\022\030\n\020rotation_speed_x\030\001 \001(\005\022\030\n\020rota"
  "tion_speed_y\030\002 \001(\005\022\030\n\020rotation_speed_z\030\003"
  " \001(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_GyroData_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_GyroData_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GyroData_2eproto = {
  false, false, descriptor_table_protodef_GyroData_2eproto, "GyroData.proto", 132,
  &descriptor_table_GyroData_2eproto_once, descriptor_table_GyroData_2eproto_sccs, descriptor_table_GyroData_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_GyroData_2eproto::offsets,
  file_level_metadata_GyroData_2eproto, 1, file_level_enum_descriptors_GyroData_2eproto, file_level_service_descriptors_GyroData_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_GyroData_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_GyroData_2eproto)), true);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
const Gyro& Gyro::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Gyro_GyroData_2eproto.base);
...
// @@protoc_insertion_point(class_specific_merge_from_start:f1x.aasdk.proto.data.Gyro)
  ...
  if (from.rotation_speed_x() != 0) {
    _internal_set_rotation_speed_x(from._internal_rotation_speed_x());
  }
  if (from.rotation_speed_y() != 0) {
    _internal_set_rotation_speed_y(from._internal_rotation_speed_y());
  }
  if (from.rotation_speed_z() != 0) {
    _internal_set_rotation_speed_z(from._internal_rotation_speed_z());
  }
}
