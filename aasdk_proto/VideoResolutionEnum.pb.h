...
enum VideoResolution_Enum : int {
  ...
  VideoResolution_Enum_VideoResolution_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  VideoResolution_Enum_VideoResolution_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class VideoResolution PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.VideoResolution) */ {
 public:
  ...
  inline VideoResolution* New() const final {
    return CreateMaybeMessage<VideoResolution>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_VideoResolutionEnum_2eproto.file_level_metadata[kIndexInFileMessages];
  }
